...
// Direct Toast component for inline usage
...
export function ToastComponent({ type, title, message, onClose, className }: ToastComponentProps) {
  const typeStyles = {
  ...
  return (
    <div
      className={cn(
        'max-w-sm w-full bg-white shadow-lg rounded-lg ring-1 ring-black ring-opacity-5 overflow-hidden',
        typeStyles[type],
        className
      )}
    >
...
// Export Toast as default for easier importing
